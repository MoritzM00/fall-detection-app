...
Implemented as a minimal React/TypeScript/Vite application. It supports the synthetic source, uploads, editable analysis windows, timestamped visual frame previews, job submission, status polling, and provenance-rich result display.
